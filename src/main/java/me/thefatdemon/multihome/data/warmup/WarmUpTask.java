...
import me.thefatdemon.multihome.MultiHomeEconManager;
	...
	public void run() {
		...
		if (player != null && player.isOnline()) {
			...
			if (location != null) {
				...
				if (cooldownTime > 0) this.plugin.getCoolDownManager().addCooldown(player, Util.dateInFuture(cooldownTime));
			}
		}
